...
paragraph describing how the user should write his source code according to the
given settings. This will be used to generate a full style definition from
